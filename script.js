...
const content = {
  ...
  en: {
    heroTitle: 'Hi, I am a <span>Freelance Developer</span>',
    heroText: 'I build web systems, interactive dashboards and automations to simplify processes, organize data and generate real results for your business.',
    heroBtn: 'Get in touch',

    aboutTitle: 'About me',
    aboutText: 'I am a developer experienced in PHP, Python, Flask, Streamlit, Dash and databases. I have built complete systems with authentication, dashboards and data analysis, always focusing on practical and well-structured solutions.',
    ...
    projectSectionText: 'Below are some examples of systems, dashboards and automations I have developed.',
